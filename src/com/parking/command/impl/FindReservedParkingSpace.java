...
public class FindReservedParkingSpace implements ParkingCommand {
	
	private ParkingLot parkingLot;
	
	public FindReservedParkingSpace() {
	...
	public void execute() throws Exception {
		...
		if(!slotFound) {
			throw new Exception("Reserved spaces are either occoupied or Reservations removed");
		}
	}
